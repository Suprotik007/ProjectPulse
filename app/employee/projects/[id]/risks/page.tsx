    ...
    <div className="min-h-screen  bg-white px-4 py-8">
      ...
      <div className="max-w-10/11 mx-auto ">
       <button
          ...
          className="px-4 py-2 text-sm border border-gray-800 rounded-lg text-gray-800 hover:bg-gray-800 hover:text-white transition mb-3"
        >
          ← Back to Dashboard
        </button>
        ...
        {/* Add Risk Form */}
        <div className="mb-6 p-4 border-2 border-gray-300 rounded-lg shadow-sm space-y-4">
          ...
          <input
            ...
            className="w-full border-2 border-gray-300 text-gray-700 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-gray-900"
          />
          <select
            value={severity}
            onChange={(e) => setSeverity(e.target.value as 'Low' | 'Medium' | 'High')}
            className="w-full border-2 text-gray-700 border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-gray-900"
          >
